...
sap.ui.define([
    ...
    function(coreLibrary, IconPool, ShortcutHintsMixin, library, InvisibleText) {
         ...
         * @namespace
         */
        var ButtonRenderer:any = {apiVersion: 2};
        ...
        ButtonRenderer.render = function(oRm, oButton) {
            ...
            ////// STS //////////
             oRm.openStart("div", sButtonId + "-sts-color");
             oRm.class("stsDrawableColorButtonColorField");
             oRm.class("sapMBtnContent");
             oRm.style("background-color", oButton.getColor());
             oRm.openEnd();
             oRm.close("div");
            ////// STS //////////
            // write icon
